...
Для того, чтобы не создавать дашборбы при каждом развертывании инфраструктуры в терраформ, сохраняем базу данных и настройки grafana в архивы, и добавляем в файл терраформ-конфигурации сервера grafana код загрузки предварительно сохраненной базы и настроек сервера grafana. После чего, при последеющем развертывании инфраструктуры средствами терраформ, дашборды восстанавливаются.  
